...
public class driver_upcoming {
    private String drive, location, position, cont_person, candidate, date, shortlisted,reject,noshow;

    public driver_upcoming(String drive, String location, String position, String cont_person, String candidate, String date, String shortlisted, String reject, String noshow, String action) {
        this.drive = drive;
