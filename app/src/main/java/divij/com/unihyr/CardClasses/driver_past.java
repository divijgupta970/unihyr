...
public class driver_past {
    ...
    public driver_past(String drive, String location, String position, String cont_person, String candidate, String date, String shortlisted, String reject, String noshow, String panelist) {
        this.drive = drive;
        this.location = location;
        this.position = position;
        this.cont_person = cont_person;
